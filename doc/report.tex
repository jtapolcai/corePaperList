...
\input{figures/conference_pies_summary.tex}
%\begin{figure}[h]
%  \centering
...
\input{figures/excellence_summary_table.tex}
...
\input{figures/journal_vs_conference_plot.tex}
...
A modern számítógépek elképesztő számítási kapacitással rendelkeznek, ezért nagyon ritka, hogy egy kutató valóban olyan feladatot próbáljon megoldani, amely saját szuperszámítógép beruházását indokolja. Sokkal gyakoribb, hogy a probléma valójában egy másik, jobban megtervezett számítási módszerrel – esetleg némi kompromisszummal – hatékonyan kezelhető lenne, ami már informatikai kutatási feladat.
...
%\end{figure}
A fentiekhez párhuzamosan az informatikai kutatás folyamatosan keresi az új alkalmazási területeket. A \ref{fig:szofelho}. ábrán a CORE A* konferenciák 2024-es felhívásaiból készített szófelhő látható, amely jól szemlélteti, milyen nagy hangsúlyt kapnak az alkalmazások.
...
\begin{figure}[h]
  ...
  \input{figures/university_ranking_plot.tex}
...
A \ref{tab:sjr_rating_summary}. táblázat azt mutatja, hányszor jelent meg azonos című folyóiratpublikáció a konferenciacikk mellett, illetve ezek az MTMT-ben milyen SJR-besorolást kaptak. Az a konferenciacikket 77\%-át nem adják be folyóiratba, vagy eltérő címen (és bővítette tartalommal) jelenik meg. A CORE A* konferenciacikkek leggyakrabban D1-es folyóiratokban kerülnek publikálásra, míg a CORE A cikkek esetében ez kevésbé jellemző: ezek túlnyomórészt Q2-es folyóiratokban jelennek meg.

\input{figures/sjr_rating_table.tex}
...
A probléma megoldását egyfelől az informatikai konferenciák elfogadásában és népszerűsítésében látjuk. 
...
%
A CORE a legelterjedtebb nemzetközi konferenciarangsor, bár nem az egyetlen. Kínában több egyetem is közvetlen finanszírozási rendszert működtet a CORE A* és A kategóriás konferenciákon megjelent publikációk támogatására, és ehhez elkészítette saját rangsorát, amely csak minimálisan tér el a CORE-besorolástól. Úgy véljük, hogy a CORE-rangsor alapvetően megbízható, nem tartalmaz súlyos besorolási hibákat, miközben egy ilyen lista folyamatos frissítése jelentős anyagi és humán erőforrást igényelne. A magyarországi informatikai kutatói közösség mérete pedig nem indokolja egy önálló nemzeti rangsor létrehozását.
...
%
Hasznos lenne a támogatási rendszer újragondolása is. Az open-access mintájára, a fiatal kutatók számára finanszírozni kellene a részvételt a vezető konferenciákon (legalább a regisztrációs díjat és az utazási költséget), hogy bátran merjenek ezekre a konferenciákra cikket beadni. Sok esetben maga a bírálati folyamat is jelentős szakmai fejlődést hoz, még elutasítás esetén is. Ráadásul ezek a konferenciák komoly láthatósági értékkel bírnak a nemzetközi tudományos közösségben.

\section{Összefoglaló értékelés}


Az itthoni folyóirat-centrikus szemlélet figyelmen kívül hagyja, hogy az informatika számos alterületén a világ vezető kutatói eredményeiket nem folyóiratokban, hanem top konferenciákon publikálják. Ez a torzulás különösen a fiatal kutatókat érinti, akiknek dönteniük kell: követik-e a nemzetközi publikációs normákat és építik nemzetközi kapcsolatrendszerüket, vagy az itthoni minősítési logikához igazodva „folyóiratosítják” az eredményeiket. Ez utóbbi elvonja a kutatástól az időjüket, és miközben a nemzetközi láthatóságuk is csökkenhet.

Magyarországon jelen van a minőségi informatikai kutatás, ám a publikációs elvárások és a finanszírozási struktúrák nem támogatják kellően a nemzetközileg releváns fórumokon való részvételt. Ezért a publikációs és értékelési rendszernek tükröznie kellene ezt a valóságot. Azt javasoljuk, hogy 
\begin{itemize}
